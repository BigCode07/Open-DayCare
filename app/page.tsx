...
// Demo seed propio del feed estático (SPEC 01/06). El feed no persiste en DB;
// la fuente de verdad de los niños vive en Supabase para las páginas /kids.
// Los ids son slugs demo, no uuid.
const KIDS_SEED: Kid[] = [
  {
    id: "mateo-fernandez",
    firstName: "Mateo",
